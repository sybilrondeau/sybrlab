...
animSections(paragraphContact, ".contact .paragraph", 0.33);
...
portfolioItems.forEach((portfolio) => {
  ...
  animSections(portfolioElements, portfolio, 0.25);
});
...
const ctaItems = document.querySelectorAll(
  ".cta__title, .cta__p, .cta__social"
);

animSections(competencesItems, ".competences-section", {
  each: 0.4,
  grid: "auto",
});
